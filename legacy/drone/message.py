class Messages:
    ENGINE_INTERRUPTED = "Engine was interrupted"
    ENGINE_READY = "Ready to Start"
    ENGINE_STARTED = "Engine started"
    ENGINE_ERROR = "Received Error at %s"
    ENGINE_STARTING = "Engine Initiating..."
    ENGINE_RUNNING = "Currently running without error"
